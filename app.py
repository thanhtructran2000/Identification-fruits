...
def predict():
    ...
    path = "static\\"+original_filename
    #IMAGE_PATHS = request.file['image']
    
    IMAGE_PATHS = path
   
    image_np = cv2.imread(IMAGE_PATHS)
    ...
    cv2.imshow('Object Detector', cv2.resize(image_np_with_detections, (1000, 600)))
...
#def predict():
    #return render_template("predict.html", output='{}'.format(result), photo='{}'.format("/static/images/" + f.filename))
